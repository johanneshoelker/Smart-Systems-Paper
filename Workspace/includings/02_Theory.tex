...
The basic expressions used in this paper are explained in the following chapters.
...
% RL techniques
RL occurs in several machine learning areas. Depending on the underlying concept different strategies to extract representations can be found. They work different in detecting patterns and store them in different ways \citeA{bishop_pattern_2006}.
