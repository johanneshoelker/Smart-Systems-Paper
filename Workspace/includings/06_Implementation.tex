...
% MEGA
\subsubsection{MEGA}
An implemention of the model MEGA is done by the authors using Python available on link \ref{foot_mega}. The repository contains scripts for replicating the results, but no further information on how to adapt the model on new datasets is given.
