...
During the research on how to use the methods for entirely new datasets, several difficulties occured. The code provided by the authors was mainly provided for replicating the found results. Given scripts took the main benchmark datasets that were mentioned in the paper as an input. Preparing entirely new datasets in order to train and use the models was impossible because of the missing knowledge of their software architecture. Providing additional data preprocessing guidelines is necessary for further development.
