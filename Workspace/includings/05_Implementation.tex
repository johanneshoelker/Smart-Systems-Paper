\section{Proof of Concept on A Test Data Set}\label{implementation}
...
To test the model with anomalies in a consistent data set the Server Machine Dataset (SMD) provided by \citeA{su_robust_2019} is used. The SMD (Server Machine Dataset) is a 5-week-long dataset made up by data from 28 different machines. The anomalies are pre labeled.\\\\
...
\subsection{Results}
% TODO Maybe like in \citeA[p. 19]{darban_carla_2024}
