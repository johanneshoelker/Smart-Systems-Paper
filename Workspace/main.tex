...
\input{includings/02_Theory}
\input{includings/03_Review}
\input{includings/04_Application}
\input{includings/05_Implementation}
\input{includings/07_Discussion_Outlook}
\bibliography{bibs/SeminarPaper.bib}
